<%@ Page Language="VB" AutoEventWireup="false" CodeFile="login.aspx.vb" Inherits="waiter_login" %><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <title>Waiter Login | Restaurant Booking System</title>
...
<body>
    ...
    <div class="container">
        <form id="form1" class="form-signin" role="form" runat="server">
            <h2 class="form-signin-heading">Waiter login:</h2>
