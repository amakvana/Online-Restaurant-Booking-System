...
<head>
    ...
    <title>Waiter Home | Restaurant Booking System</title>
...
<body>
            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        ...
                        <li><a href="editbooking.aspx">Edit Booking</a></li>
                    </ul>
                    <ul class="nav nav-sidebar">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h2 class="sub-header">Bookings
                        <asp:Button ID="btnRefreshBookings" runat="server" Text="Refresh" CssClass="btn-to-a" /></h2>

                    <asp:Label runat="server" Text="Filter:" ID="Label1" />
                    ...
                    <br />
                    <input type="hidden" id="wid" value="" runat="server" />
                    <input type="hidden" id="wrid" value="" runat="server" />
    ...
    <script src="../js/waiter.min.js"></script>
</body>
</html>
