<%@ Page Language="VB" AutoEventWireup="false" CodeFile="register.aspx.vb" Inherits="owner_register" %><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <title>Owner Registration | Restaurant Booking System</title>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <asp:Label ID="lblHeader" runat="server" Text="Restaurant Owner Registration"></asp:Label>
                    </h3>
                </div>
