<%@ Page Language="VB" AutoEventWireup="false" CodeFile="login.aspx.vb" Inherits="owner_login" %><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <title>Owner Login | Restaurant Booking System</title>
...
<body>
    ...
    <div class="container">
        <form id="form1" class="form-signin" role="form" runat="server">
            <h2 class="form-signin-heading">Owner login:</h2>
