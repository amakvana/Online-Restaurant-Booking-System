<%@ Page Language="VB" AutoEventWireup="false" CodeFile="menu.aspx.vb" Inherits="owner_menu" %><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <title>Owner Home | Restaurant Booking System</title>
...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h2 class="sub-header">My Restaurants <asp:Button ID="btnRefreshRestaurants" runat="server" Text="Refresh" CssClass="btn-to-a" /></h2>
                    <div class="table-responsive">
                        <asp:Table id="MyRestaurantsTable" class="table table-striped" runat="server">
                        </asp:Table>
                    </div>
                    <br />
                    <h2 class="sub-header">My Waiters</h2>
                    <asp:Label runat="server" Text="Filter by Restaurant ID:" ID="Label1" />
                    <asp:DropDownList ID="ddlFilter" runat="server" CssClass="form-control">
                    </asp:DropDownList>
                    <asp:Button ID="btnGetStaff" runat="server" Text="Get Waiters" CssClass="btn btn-block" />
                    <br />
                    <input type="hidden" id="oid" value="" runat="server" />
                    <input type="hidden" id="rid" value="" runat="server" />
                    <div class="table-responsive">
                        <asp:Table id="MyStaffTable" CssClass="table table-striped" runat="server">
                        </asp:Table>
                    </div>
                </div>
            </div>
    ...
    <script src="../js/owner.min.js"></script>
</body>
</html>