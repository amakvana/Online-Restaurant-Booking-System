<%@ Page Language="VB" AutoEventWireup="false" CodeFile="thebulldog.aspx.vb" Inherits="restaurant_thebulldog" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>The Bulldog | NOTTINGHAM</title>
    <meta name="description" content="A small restaurant located at 60 Whatlington Road in Nottingham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; The Bulldog</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>The Bulldog</h1>
                <p class="lead">A small restaurant located at 60 Whatlington Road in Nottingham.</p>
