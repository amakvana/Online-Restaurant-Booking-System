<%@ Page Language="VB" AutoEventWireup="false" CodeFile="carnivorekitchen.aspx.vb" Inherits="restaurant_carnivorekitchen" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Carnivore Kitchen | NOTTINGHAM</title>
    <meta name="description" content="A small restaurant located at 23 Russell Rd in Nottingham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Carnivore Kitchen</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Carnivore Kitchen</h1>
                <p class="lead">A small restaurant located at 23 Russell Rd in Nottingham.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@carnivorekitchen.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07897397120</td>
