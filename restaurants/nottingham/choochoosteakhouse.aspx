<%@ Page Language="VB" AutoEventWireup="false" CodeFile="choochoosteakhouse.aspx.vb" Inherits="restaurant_choochoosteakhouse" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Choo Choo Steakhouse | NOTTINGHAM</title>
    <meta name="description" content="A large restaurant located at 94 Neville Street in Nottingham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Choo Choo Steakhouse</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Choo Choo Steakhouse</h1>
                <p class="lead">A large restaurant located at 94 Neville Street in Nottingham.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@choochoosteakhouse.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07849747059</td>
