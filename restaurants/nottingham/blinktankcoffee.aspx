<%@ Page Language="VB" AutoEventWireup="false" CodeFile="blinktankcoffee.aspx.vb" Inherits="restaurant_blinktankcoffee" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Blink Tank Coffee | NOTTINGHAM</title>
    <meta name="description" content="A small coffee cafe located at 64 Park End St in Nottingham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Blink Tank Coffee</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Blink Tank Coffee</h1>
                <p class="lead">A small coffee cafe located at 64 Park End St in Nottingham.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@blinktankcoffee.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07847990123</td>
