<%@ Page Language="VB" AutoEventWireup="false" CodeFile="oasislounge.aspx.vb" Inherits="restaurant_oasislounge" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Oasis Lounge | BIRMINGHAM</title>
    <meta name="description" content="A small restaurant located at 43 Friar Street in Birmingham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Oasis Lounge</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Oasis Lounge</h1>
                <p class="lead">A small restaurant located at 43 Friar Street in Birmingham.</p>
