<%@ Page Language="VB" AutoEventWireup="false" CodeFile="splicebarandgrill.aspx.vb" Inherits="restaurant_splicebarandgrill" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Splice Bar and Grill | BIRMINGHAM</title>
    <meta name="description" content="A cosy restaurant located at 41 Redcliffe Way in Birmingham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Splice Bar and Grill</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Splice Bar and Grill</h1>
                <p class="lead">A cosy restaurant located at 41 Redcliffe Way in Birmingham.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@splicebarandgrill.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07823847023</td>
