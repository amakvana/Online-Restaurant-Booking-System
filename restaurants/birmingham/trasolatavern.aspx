<%@ Page Language="VB" AutoEventWireup="false" CodeFile="trasolatavern.aspx.vb" Inherits="restaurant_trasolatavern" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Trasola Tavern | BIRMINGHAM</title>
    <meta name="description" content="A comfy tavern located at 38 Tadcaster Rd in Birmingham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Trasola Tavern</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Trasola Tavern</h1>
                <p class="lead">A comfy tavern located at 38 Tadcaster Rd in Birmingham.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@trasolatavern.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07893477401</td>
