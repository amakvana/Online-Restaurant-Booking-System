<%@ Page Language="VB" AutoEventWireup="false" CodeFile="heybuddha.aspx.vb" Inherits="restaurant_heybuddha" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Hey Buddha | BIRMINGHAM</title>
    <meta name="description" content="A traditional, warm restaurant located at 55 Harehills Lane in Birmingham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Hey Buddha</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Hey Buddha</h1>
                <p class="lead">A traditional, warm restaurant located at 55 Harehills Lane in Birmingham.</p>
