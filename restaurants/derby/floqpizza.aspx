<%@ Page Language="VB" AutoEventWireup="false" CodeFile="floqpizza.aspx.vb" Inherits="restaurant_floqpizza" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Floq Pizza | DERBY</title>
    <meta name="description" content="A small pizzeria located at  in Derby.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Floq Pizza</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Floq Pizza</h1>
                <p class="lead">A small pizzeria located at  in Derby.</p>
