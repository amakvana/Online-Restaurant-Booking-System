<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mardigras.aspx.vb" Inherits="restaurant_mardigras" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Mardi Gras | DERBY</title>
    <meta name="description" content="A restaurant located at 11 Boroughbridge Road in Derby.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Mardi Gras</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Mardi Gras</h1>
                <p class="lead">A restaurant located at 11 Boroughbridge Road in Derby.</p>
