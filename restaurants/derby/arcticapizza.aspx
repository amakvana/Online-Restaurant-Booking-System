<%@ Page Language="VB" AutoEventWireup="false" CodeFile="arcticapizza.aspx.vb" Inherits="restaurant_arcticapizza" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Arctica Pizza | DERBY</title>
    <meta name="description" content="A small pizzeria located at 25 Earls Avenue in Derby.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Arctica Pizza</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Arctica Pizza</h1>
                <p class="lead">A small pizzeria located at 25 Earls Avenue in Derby.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@arcticapizza.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07848373403</td>
