<%@ Page Language="VB" AutoEventWireup="false" CodeFile="banjosushi.aspx.vb" Inherits="restaurant_banjosushi" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Banjo Sushi | LONGFORMACUS</title>
    <meta name="description" content="A restaurant located at 29 Neville Street in Longformacus.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Banjo Sushi</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Banjo Sushi</h1>
                <p class="lead">A restaurant located at 29 Neville Street in Longformacus.</p>
