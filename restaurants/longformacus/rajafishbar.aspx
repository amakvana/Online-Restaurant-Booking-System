<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rajafishbar.aspx.vb" Inherits="restaurant_rajafishbar" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Raja Fish & Chips | LONGFORMACUS</title>
    <meta name="description" content="A fish & chip shop located on the corner of Great Western Road, Longformacus. We offer a wide variety of different fish and the finest potato chips to compliment them.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Raja Fish & Chips</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Raja Fish & Chips</h1>
                <p class="lead">A fish & chip shop located on the corner of Great Western Road, Longformacus. We offer a wide variety of different fish and the finest potato chips to compliment them.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@rajafishchips.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07872509892</td>
