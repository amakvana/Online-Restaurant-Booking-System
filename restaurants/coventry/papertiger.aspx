<%@ Page Language="VB" AutoEventWireup="false" CodeFile="papertiger.aspx.vb" Inherits="restaurant_papertiger" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Paper Tiger | COVENTRY</title>
    <meta name="description" content="A cosy restaurant located at 1 Wrexham Road in Coventry.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Paper Tiger</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Paper Tiger</h1>
                <p class="lead">A cosy restaurant located at 1 Wrexham Road in Coventry.</p>
