<%@ Page Language="VB" AutoEventWireup="false" CodeFile="yoyotokyo.aspx.vb" Inherits="restaurant_yoyotokyo" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Yo Yo Tokyo | COVENTRY</title>
    <meta name="description" content="A restaurant located at 26 Cloch Rd in Coventry.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Yo Yo Tokyo</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Yo Yo Tokyo</h1>
                <p class="lead">A restaurant located at 26 Cloch Rd in Coventry.</p>
