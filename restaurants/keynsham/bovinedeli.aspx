<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bovinedeli.aspx.vb" Inherits="restaurant_bovinedeli" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Bovine Deli | KEYNSHAM</title>
    <meta name="description" content="A small deli located at 2 Graham Road in Keynsham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Bovine Deli</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Bovine Deli</h1>
                <p class="lead">A small deli located at 2 Graham Road in Keynsham.</p>
