<%@ Page Language="VB" AutoEventWireup="false" CodeFile="qiaobar.aspx.vb" Inherits="restaurant_qiaobar" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Qiao Bar | KEYNSHAM</title>
    <meta name="description" content="A traditional restaurant located at 14 Worthy Lane in Keynsham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Qiao Bar</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Qiao Bar</h1>
                <p class="lead">A traditional restaurant located at 14 Worthy Lane in Keynsham.</p>
