<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cricketbistro.aspx.vb" Inherits="restaurant_cricketbistro" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Cricket Bistro | KEYNSHAM</title>
    <meta name="description" content="A lively restaurant located at 11 Cambridge Road in Keynsham.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Cricket Bistro</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Cricket Bistro</h1>
                <p class="lead">A lively restaurant located at 11 Cambridge Road in Keynsham.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@cricketbistro.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07308390128</td>
