<%@ Page Language="VB" AutoEventWireup="false" CodeFile="artichokealleybar.aspx.vb" Inherits="restaurant_artichokealleybar" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Artichoke Alley Bar | KEYNSHAM</title>
    <meta name="description" content="A small bar located in the heart of Keynsham and is home to some of the most finest English food available!">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Artichoke Alley Bar</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Artichoke Alley Bar</h1>
                <p class="lead">A small bar located in the heart of Keynsham and is home to some of the most finest English food available!</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>info@artichokealleybar.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07068867134</td>
