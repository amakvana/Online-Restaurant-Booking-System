<%@ Page Language="VB" AutoEventWireup="false" CodeFile="augustmoon.aspx.vb" Inherits="restaurant_augustmoon" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>August Moon | Fakeland</title>
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; August Moon</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>August Moon</h1>
                <p class="lead">A nice restaurant.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@thebigrestaurant.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>44123456789</td>
