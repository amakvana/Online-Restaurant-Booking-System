<%@ Page Language="VB" AutoEventWireup="false" CodeFile="jerseylounge.aspx.vb" Inherits="restaurant_jerseylounge" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Jersey Lounge | LEICESTER</title>
    <meta name="description" content="A small restaurant located at 91 Harrogate Road in Leicester.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Jersey Lounge</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Jersey Lounge</h1>
                <p class="lead">A small restaurant located at 91 Harrogate Road in Leicester.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@jerseylounge.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07961107968</td>
