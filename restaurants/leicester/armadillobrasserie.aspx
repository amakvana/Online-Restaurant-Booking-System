<%@ Page Language="VB" AutoEventWireup="false" CodeFile="armadillobrasserie.aspx.vb" Inherits="restaurant_armadillobrasserie" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Armadillo Brasserie | LEICESTER</title>
    <meta name="description" content="A small restaurant located at 89 Annfield Rd in Leicester.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Armadillo Brasserie</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Armadillo Brasserie</h1>
                <p class="lead">A small restaurant located at 89 Annfield Rd in Leicester.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@armadillobrasserie.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07071198686</td>
