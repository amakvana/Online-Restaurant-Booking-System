<%@ Page Language="VB" AutoEventWireup="false" CodeFile="hotboxcoffee.aspx.vb" Inherits="restaurant_hotboxcoffee" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Hot Box Coffee | LEICESTER</title>
    <meta name="description" content="A small cafe located at11 Stone Cellar Road in Leicester.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Hot Box Coffee</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Hot Box Coffee</h1>
                <p class="lead">A small cafe located at 11 Stone Cellar Road in Leicester.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@hotboxcoffee.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07981701184</td>
