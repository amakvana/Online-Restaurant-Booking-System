<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fancycuisine.aspx.vb" Inherits="restaurant_fancycuisine" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Fancy Cuisine | LEICESTER</title>
    <meta name="description" content="A fancy cuisine in leicester.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Fancy Cuisine</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Fancy Cuisine</h1>
                <p class="lead">A fancy cuisine in leicester.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@fancycuisine.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07435679676</td>
