<%@ Page Language="VB" AutoEventWireup="false" CodeFile="clubcastawaybbq.aspx.vb" Inherits="restaurant_clubcastawaybbq" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Club Castaway BBQ | NORTHAMPTON</title>
    <meta name="description" content="A small BBQ restaurant located at 40 High St in Northampton.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Club Castaway BBQ</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Club Castaway BBQ</h1>
                <p class="lead">A small BBQ restaurant located at 40 High St in Northampton.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@clubcastawaybbq.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07874892374</td>
