<%@ Page Language="VB" AutoEventWireup="false" CodeFile="tikitacocantina.aspx.vb" Inherits="restaurant_tikitacocantina" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Tiki Taco Cantina | NORTHAMPTON</title>
    <meta name="description" content="A restaurant located at 74 Gloddaeth Street in Northampton.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Tiki Taco Cantina</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Tiki Taco Cantina</h1>
                <p class="lead">A restaurant located at 74 Gloddaeth Street in Northampton.</p>
                            ...
                            <fieldset>
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Email:</th>
                                            <td>contact@tikitacocantina.com</td>
                                        </tr>
                                        <tr>
                                            <th>Phone number:</th>
                                            <td>07846342894</td>
