<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sugarpine.aspx.vb" Inherits="restaurant_sugarpine" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Sugarpine | CWMCARVAN</title>
    <meta name="description" content="A fine, A La Carte restaurant located at 68 Ockham Road in Cwmcarvan.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Sugarpine</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Sugarpine</h1>
                <p class="lead">A fine, A La Carte restaurant located at 68 Ockham Road in Cwmcarvan.</p>
