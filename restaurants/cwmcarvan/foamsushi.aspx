<%@ Page Language="VB" AutoEventWireup="false" CodeFile="foamsushi.aspx.vb" Inherits="restaurant_foamsushi" %><!DOCTYPE html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>Foam Sushi | CWMCARVAN</title>
    <meta name="description" content="A small restaurant located at 56 Harehills Lane in Cwmcarvan.">
...
<body data-spy="scroll" data-target=".navbar">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="#home"><i class="icon-food"></i>&nbsp; Foam Sushi</a>
    ...
    <section id="home" class="fill">
        <div class="container">
            <div class="wrapper">
                <h1 class="upper">WELCOME TO<br>Foam Sushi</h1>
                <p class="lead">A small restaurant located at 56 Harehills Lane in Cwmcarvan.</p>
